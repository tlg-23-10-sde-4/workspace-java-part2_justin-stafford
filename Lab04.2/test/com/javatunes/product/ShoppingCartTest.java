...
public class ShoppingCartTest {
  ...
  public void testProductCart() {
    ShoppingCart<Product> cart = new ShoppingCart<>();// what the <T> means? product! because
    // Music and MediaPlayer are all subclasses of Product
   ...
   */
  @Test
  public void testMusicItemCart() {  // shopping cart of MusicItems
